...
<li class="nav-item">
    <a class="nav-link {{ (Route::is('admin.user.show') || Route::is('admin.user.add')) ? '' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapseTwo"
        aria-expanded="{{ (Route::is('admin.user.show') || Route::is('admin.user.add')) ? true : false }}" aria-controls="collapseTwo">
        <i class="fas fa-user"></i>
        <span>User</span>
    </a>
    <div id="collapseTwo" class="collapse {{ (Route::is('admin.user.show') || Route::is('admin.user.add')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
